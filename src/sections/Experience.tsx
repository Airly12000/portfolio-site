            ...
            {tab === 1 && (
              <div className="col exp-details">
                <h3 className="col-light fw-b">
                  NSP (Software Engineer){" "}
                  <span className="col-green">
                    @ Inngen Technology Solutions
                  </span>
                </h3>
                <h6 className="mono">November 2023 - Present</h6>
                <ul>
                  <li>
                    Successfully undertook a certificate training program on
                    "Managing the Workplace for Improved Productivity" delivered
                    by the Management Development and Productivity Institute,
                    Ghana (MDPI).
                  </li>
                </ul>
              </div>
            ...
            {tab === 2 && (
              <div className="col exp-details">
                ...
                <ul>
                  ...
                  <li>
                    Employing the capabilities of React Native framework in
                    mobile development, enabling me to craft versatile and
                    powerful applications for various platforms efficiently and
                    effectively.
                  </li>
                </ul>
              </div>
